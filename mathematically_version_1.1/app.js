...
function myFunction1() {
    ...
    if (inputNumber1.length != 4) {
        document.querySelector("#myP1").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction2() {
    ...
    if (inputNumber2.length != 4) {
        document.querySelector("#myP2").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction3() {
    ...
    if (inputNumber3.length != 4) {
        document.querySelector("#myP3").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction4() {
    ...
    if (inputNumber4.length != 4) {
        document.querySelector("#myP4").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction5() {
    ...
    if (inputNumber5.length != 4) {
        document.querySelector("#myP5").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction6() {
    ...
    if (inputNumber6.length != 4) {
        document.querySelector("#myP6").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction7() {
    ...
    if (inputNumber7.length != 4) {
        document.querySelector("#myP7").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction8() {
    ...
    if (inputNumber8.length != 4) {
        document.querySelector("#myP8").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
...
function myFunction9() {
    ...
    if (inputNumber9.length != 4) {
        document.querySelector("#myP9").innerHTML = (`Lütfen 4 haneli <br> bir sayı giriniz.`)
